        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipppingFirstName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ShipppingLastName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SipppingEmail = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SipppingPhoneNumber = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    SipppingAddress = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    SipppingCity = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    SipppingPostalCode = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    SipppingCountry = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BikeImage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BikeImage_Bike_BikeId",
                        column: x => x.BikeId,
                        principalTable: "Bike",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
